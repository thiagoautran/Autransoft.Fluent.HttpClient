...
namespace Autransoft.Fluent.HttpClient.Lib.Helpers
{
    internal static class PostmanHelper
    {
        ...
        internal static string GeneratePostmanCode(Verbs verb, string uri, Dictionary<string, string> headers, string token, Dictionary<string, string> formData, string json)
        {
            var postman = new StringBuilder();
